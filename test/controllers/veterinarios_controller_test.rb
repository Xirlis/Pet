...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference("Veterinario.count") do
      post veterinarios_url, params: { veterinario: { email: @veterinario.email, idade: @veterinario.idade, nome: @veterinario.nome, telefone: @veterinario.telefone } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { email: @veterinario.email, idade: @veterinario.idade, nome: @veterinario.nome, telefone: @veterinario.telefone } }
