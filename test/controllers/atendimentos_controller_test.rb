...
class AtendimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendimento" do
    assert_difference("Atendimento.count") do
      post atendimentos_url, params: { atendimento: { animal_id: @atendimento.animal_id, atendimentos_data: @atendimento.atendimentos_data, veterinario_id: @atendimento.veterinario_id } }
    end
  ...
  test "should update atendimento" do
    patch atendimento_url(@atendimento), params: { atendimento: { animal_id: @atendimento.animal_id, atendimentos_data: @atendimento.atendimentos_data, veterinario_id: @atendimento.veterinario_id } }
